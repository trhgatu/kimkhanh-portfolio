...
export function HeroAboutDivider() {
  ...
  return (
    <div
      ref={rootRef}
      aria-hidden="true"
      className="relative z-30 -mb-14 -mt-16 flex h-32 items-center bg-[var(--color-blush)] sm:-mb-20 sm:-mt-24 sm:h-44"
    >
      <div className="flex w-full items-center justify-center px-6 sm:px-10">
        <div ref={flowerRef} className="relative h-24 w-24 shrink-0 sm:h-36 sm:w-36">
          <Image
